...
cleanString = re.sub('/[^(\x20-\x7F)]*/','', my_string)
print(cleanString)
print('\n')

"""
val = 'Work closely with end users on any â€˜agileâ€™ projects Â';

array = ['À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í',
...
string_nonASCII = "Soothe as you cleanse with this gentle, soap-free shower gel â€“ specially formulated to respect your skinâ€™"
